...
public class pyParserApp {
    ...
    public static void main(String[] args) {
        ...
        // ==========================
        if (args.length == 0) {
            System.out.println("Uso: java pyParserApp <ficheiro.py>");
            return;
        }
        ...
        try {
            ...
            pyLexer lexer = new pyLexer(charStream);
            ...
            for (Token token : tokens.getTokens()) {
                String name = pyLexer.VOCABULARY.getSymbolicName(token.getType());
